import { afficherTravaux } from "./dossier-javascript/index.js";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function supprimerTravail(id) {
    try {
      ...
      console.error(
        `Erreur lors de la requête de suppression du travail avec ID ${id} :`,
        error
      );
    }
  }
  ...
  document
    ...
    .addEventListener("click", openAjoutPhotoModal);
  ...
  function setupFormListeners() {
    ...
    document
      .querySelector(".js-close-ajout-modal")
      .addEventListener("click", closeAjoutPhotoModal);
    document
      .querySelector(".js-retour-arriere")
      .addEventListener("click", retourArriereModal);
